...
Clone or Download the ProjectDownload the project files or clone the repository to your local machine.

Install DependenciesEnsure you have Python installed. Then, install the required pandas library using pip:
pip install pandas

Verify SetupEnsure the following files are created automatically on first run: appointments.csv, prescriptions.csv, drugs.csv, and treatments.csv.

Usage :

Run the ApplicationNavigate to the project directory and run the script:
python doctor_system.py

Interact with the MenuThe application provides a console-based menu with the following options:
...
Contact
For questions or support, please contact the developer at [akash02155@gmail.com].
